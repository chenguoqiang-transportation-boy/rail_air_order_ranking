...
from optimization_pressure_priority_search import TwoStageOptimizer
...
class Simulator:
    def __init__(self, config: Dict, data_dir: str, file_params: Dict[str, str], score_weights: Dict[str, float] = None):
        self.config = config
        ...
        self.optimizer = TwoStageOptimizer(self.cost_calc, score_weights=score_weights)
